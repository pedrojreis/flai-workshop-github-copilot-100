...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team with tournaments and practice sessions",
    ...
    "Science Olympiad": {
        "description": "Compete in STEM challenges and prepare for science competitions",
